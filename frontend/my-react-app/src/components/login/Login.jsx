                    ...
                    <div className="login-container m-auto">
                        ...
                        <div className="image-section">
                            ...
                            <div className="image-overlay">
                                <div className="image-content">
                                    ...
                                    <p>
                                        Experience the artistry of premium furniture design. Each piece
                                        tells a story of craftsmanship, quality, and enduring beauty.
                                    </p>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-header">
                                <h1>Welcome Back</h1>
                                <p>
                                    Sign in to access your exclusive member benefits, track orders, and
